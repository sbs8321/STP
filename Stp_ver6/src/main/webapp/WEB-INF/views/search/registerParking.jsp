...
<body>
	...
	<h1>주차장 등록</h1>
	<form name="registerParking" id="registerParking" action="registerParking"
		method="post">
		<p>
			<input type="text" name="prkplcenm" id="prkplcenm" placeholder="주차장 이름" style="width: 300px;" required="required">
		</p>
		<p>
		...
		<p>
			<input type="text" name="prkcmprt" id="prkcmprt" placeholder="구획수" required="required">
			<input type="text" name="basictime" id="basictime" placeholder="기본주차시간" required="required">분
		</p>
		<p>
			<input type="text" name="basiccharge" id="basiccharge" placeholder="기본요금" style="width: 90px;" required="required">원
			<input type="text" name="daycmmtkt" id="daycmmtkt" placeholder="하루 요금" style="width: 90px;" required="required">원
			<input type="number" name="hourPayment" id="hourPayment" placeholder="시간당요금" style="width: 90px;" required="required">원
		</p>
		<p>
