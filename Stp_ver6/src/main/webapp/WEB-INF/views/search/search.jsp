...
<body>
					...
					<li class="nav-item dropdown">
						<div class="listButton">
							...
							<div class="dropdown-menu dropdown-menu-right"
								...
								<!-- owner인 경우 -->
								<div class="ownerButton" style="display: none">
									<a class="dropdown-item" href="javascript:exchangeList()">환전 신청
										내역</a>
								</div>
							</div>
						</div>
	...
	<div align="center" style="margin-top: 150px;">
		<h1 style="align-content: center;">
			<img src="../resources/img/logo/logo.png" width="700px"
				style="margin: auto">
		</h1>
	</div>
	...
	<div align="center" style="margin-top: 70px;">
		<form action="../search/search" method="post">
			<input type="text" id="place" name="place"
				style="width: 600px; height: 50px; background-color: #dcdcdc" />
	...
	<input type="hidden" id=email name="email" value="${sessionScope.loginID}">
	<script>
