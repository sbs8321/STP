	...
	<div style="width: 100%; text-align: center;" id="container">
		...
		<div style="display: inline-block; width: 70%;">
			...
			<form name="bookTime" id="bookTime" action="bookable" method="post">
				...
				<br>
				<div align="center">
					<a href="javascript:bookable()" class="btn btn-primary float-right"	>검색</a>
				</div>
			</form>
		</div>

		<div id="bookable_result" style="display: inline-block; width: 70%;"></div>
		<br>


		<div id="" style="display: inline-block; width: 1100px;">
			<hr>
			<div
				style="float: left; width: 240px; height: 220px; margin: 0 20px 0 200px; border: 1px solid blue;">
				<img src="${parkDetail.parkimg}" width="230" height="210">
				</div>

			<div id="bookmark" style="float: right; margin-right: 180px"></div>

			<div style="margin: 0 auto;">
				<table class="table table-hover"
					style="width: 400px; text-align: left; height: 180px;">
					<tr>
						<td colspan=2><b style="font-size: large;">
								${parkDetail.prkplcenm } </b> <span style="font-size: small;">${parkDetail.prkplcese }·${parkDetail.prkplcetype }</span></td>
					</tr>
					<tr>
						<td colspan=2>${parkDetail.rdnmadr }</td>
					</tr>
					<tr>
						<td rowspan=3 style="text-align: center; line-height: 85px">이용
							요금</td>
			...
			<div id="" style="display: inline-block; width: 1100px;">
				<div id="staticMap"
					style="width: 600px; height: 350px; display: inline-block;"></div>
			</div>
		...
		<div id=""
			style="display: inline-block; width: 1100px; text-align: left">
			<input type="hidden" name="sessionId" id="sessionId"
				value=<%=session.getAttribute("loginID")%>>

			<div style="margin-left: 200px;">
				<input style="width: 500px; padding-left: 10px; height: 32px;"
					type="text" placeholder="댓글 작성.." class="reply_content"
					name="reply_content" id="reply_content" onkeyup="enterkey();">&nbsp;
				<input type="button" class="btn btn-outline-success"
					onclick="replySubmit()" value="작성">
			</div>
			<br>
			<div style="margin-left: 200px;" id="replies"></div>
		</div>
