...
<body>
	...
	<div align="center" style="margin-top: 60px;">
		<form action="search" method="post">
			<input type="text" id="place" name="place"
				style="width: 600px; height: 50px; background-color: Silver" />
			<button type="submit">검색</button>
		</form>
	</div>

	<div id="map" style="width: 70%; height: 380px; margin: auto;"></div>
	...
	<div id="pkList"
		style="width: 70%; height: 300px; margin: auto; overflow: auto"></div>
	...
	<script>
		...
		var pkmk = {
			...
			'    <div class="info">'
					...
					+ '        <div class="body">'
					+ '            <div class="img">'
					+ '                <img src="${pk.parkimg}" width="73" height="70">'
					+ '           </div>'
					+ '            <div class="desc">'
					+ '                <div class="iss"><h5>${pk.rdnmadr} &nbsp</h5></div>'
					+ '            </div>' + '        </div>' + '    </div>',
